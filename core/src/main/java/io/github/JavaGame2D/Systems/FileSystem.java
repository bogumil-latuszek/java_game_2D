...
public class FileSystem {
    ...
    public void loadPlayerAnimations(AnimationManager animationManager){
        try {
            ...
            Texture runningFrame1Texture = new Texture(directory+"run1"+fileExtension);
            ...
            Drawable runningFrame1 = new Drawable(runningFrame1Texture, FacingDirection.RIGHT);
            ...
            Animation running = new Animation(new Drawable[]{runningFrame1});
            running.framesPerSecond = 3;
            ...
            animationManager.addAnimation(CharacterType.PLAYER, BodySegmentType.UPPER_BODY, AnimationType.WALKING, running);
