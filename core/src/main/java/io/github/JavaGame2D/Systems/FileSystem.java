...
public class FileSystem {
    ...
    public void loadPlayerAnimations(AnimationManager animationManager){
        try {
            ...
            Drawable idleFrame1 = new Drawable(idleFrame1Texture, FacingDirection.RIGHT);
            ...
            Drawable walkingFrame3 = new Drawable(walkingFrame3Texture, FacingDirection.RIGHT);
            Drawable walkingFrame4 = new Drawable(walkingFrame4Texture, FacingDirection.RIGHT);
            Drawable walkingFrame5 = new Drawable(walkingFrame5Texture, FacingDirection.RIGHT);
            Drawable walkingFrame6 = new Drawable(walkingFrame6Texture, FacingDirection.RIGHT);
            ...
            Animation walking = new Animation(new Drawable[]{walkingFrame1,walkingFrame2,walkingFrame3,
