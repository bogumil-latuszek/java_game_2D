...
public class CharacterAnimations {
    ...
    public Texture getFrameByNumber(BodySegmentType segment, AnimationType animationType, int frameNumber){
    ...
    public Texture getFrameByDuration(BodySegmentType segment, AnimationType animationType, float durationInMilliseconds){
        BodySegmentAnimations segmentAnimations = animations.get(segment);
        if ( segmentAnimations == null ){
            return null;
        }
